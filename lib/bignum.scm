...
(define (make-bignum len)              (make-u16vector len 0))
(define (bignum-length bn)             (u16vector-length bn))
(define (bignum-sign bn)               (u16vector-ref bn 0))
(define (bignum-sign-set! bn sign)     (u16vector-set! bn 0 sign))
(define (bignum-digit-ref bn i)        (u16vector-ref bn i))
(define (bignum-digit-set! bn i digit) (u16vector-set! bn i digit))
...
(define (bignum->string x #!optional (radix 10)) ;; 2 <= radix <= 36
...
(define (string->bignum str #!optional (radix 10)) ;; 2 <= radix <= 36
